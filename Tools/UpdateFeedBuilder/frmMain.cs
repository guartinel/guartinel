...
namespace FeedBuilder {
   public partial class frmMain : Form {
      ...
      private void cmdBuild_Click (Object sender,
            EventArgs e) {
         Build() ;
      }

      private void btnOpenOutputs_Click (object sender,
            EventArgs e) {
         OpenOutputsFolder() ;
      }
      ...
      private void btnSaveAs_Click (Object sender,
            EventArgs e) {
         Save (true) ;
      }
      ...
      private void cmdOutputFolder_Click (Object sender,
            EventArgs e) {
         if (Properties.Settings.Default.LastOutputPath == null) {
           Properties.Settings.Default.LastOutputPath =  Environment.GetFolderPath (Environment.SpecialFolder.MyDocuments) ;
         }
      
         fbdOutputFolder.SelectedPath = Properties.Settings.Default.LastOutputPath ;
      ...
      private void cmdFeedXML_Click (Object sender,
            EventArgs e) {
      ...
      private void chkIgnoreSymbols_CheckedChanged (object sender,
            EventArgs e) {
         ReadFiles() ;
      }

      private void chkCopyFiles_CheckedChanged (Object sender,
            EventArgs e) {
      ...
      private void ReadFiles() {
         ...
         foreach (FileInfo fi in enumerator.Matches()) {
            ...
            if ((IsIgnorable (filePath))) continue ;
