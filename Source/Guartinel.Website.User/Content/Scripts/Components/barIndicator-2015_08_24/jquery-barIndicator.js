	...
	Plugin.prototype = {
		...
		_init: function() {
			...
			if (style == 'vertical') {	
				...
				var bar = '<div class="bi-bar" style="height:' + bh + 'px">' + numLabelEdge + '<div class="bi-barInner">' +
				   '<div class="innerLabel" layout layout-align="center center">'+ opt.data + '%' + '</div></div></div>';
